...
<body >
        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2" style="background-image: url();">
            ...
            <td height="40" colspan="3">
              ...
              <div align="right"style=" padding: 20px 0 0 20px;color:#666;font-size:14px;margin-bottom:30px">
                ...
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">Harga satuan :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right; padding-left: 4px">{{$order->order_currency}}{{price_format($goods->goods_price)}}</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">Qty :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_num}}</p>
                </div>
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">Harga promosi :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}{{price_format(($goods->goods_price*$order->order_num)-($order->order_price))}}</p>
                </div>
                <div style="text-align: right;">
                ...
                <div style="text-align: right;">
                  <p style="display:inline-block;margin: 6px 0;">Total :</p><p style="display:inline-block;width: 100px;;margin: 6px 0;text-align: right;padding-left: 4px">{{$order->order_currency}}{{price_format($order->order_price)}}</p>
                </div>
              </div>
              @else
              <div align="right"style=" padding: 20px 0 0 20px;color:#666;font-size:14px;margin-bottom:30px">
          ...
          "><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Email ini hanya digunakan untuk mengkonfirmasi pesanan Anda di</font></font><a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a style="color:#F8770E" target="_blank" href="http://{{$url}}">{{$url}}</a></font></font></a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                 ...
                 </font></font><a href="mailto:servis@fleekgo.com" style="color:#F8770E">servis@fleekgo.com</a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 
          ...
          <tr>
            ...
            <a href="mailto:servis@fleekgo.com" ><font  style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a style="color:#F8770E" target="_blank" href="http://{{$url}}">{{$url}}</a></font></font></a>
            </p></td>
          </tr>
        </tbody></table>
        <p>&nbsp;</p>
