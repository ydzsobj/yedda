...
<header class="mui-bar mui-bar-nav" style="background:#fff;">
    ...
    <div class="pay_success">
            <h2 style="padding:16px 0px 10px 0px; text-align:center; color:#3cba92">Success!</h2>
                        ...
                        Your order number :<font color="red"style="user-select: text;" id="copyOrder">{{$order->order_single_id}}</font>                
                        <img src="/img/copy.png" style="height: 15px;width: 15px;" onclick="copyOrder()">
                <input type="text" value="" id="copyOrderTextarea" style="position: absolute;top: 0;left: 0;opacity: 0;z-index: -10;"><br>
                        Payable :<font color="red">{{\App\currency_type::where('currency_type_id',$goods->goods_currency_id)->first()['currency_type_name']}} {{$order->order_price}}</font>
                                ...
                                <div style="text-align:left;padding:10px 15px 20px">
                                            <!--同一个币种不同团队的邮箱不一样-->
                                            Please keep your mobile phone unblocked, so that the courier can contact you in time. If you have any questions, please contact our online customer service in time. Have fun shopping!     <a href="mailto:rbzjlprc@gmail.com" style="color:#F8770E">rbzjlprc@gmail.com</a>        </div>            </div>
