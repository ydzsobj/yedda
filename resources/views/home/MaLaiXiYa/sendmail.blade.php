        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="2" style="background-image: url();">
          ...
          <tr>
            <td height="40" colspan="3"style="color:#666;font-size:14px;border-top: 1px solid #F29400;"><p style="
              margin-top: 48px;
          "><font style="vertical-align: inherit;">This email is only used for confirmation of your order for shopping on this website. This is an auto-generated email. Please DO NOT REPLY. Please contact us with<a href="mailto:rbzjlprc@gmail.com" style="color:#F8770E">rbzjlprc@gmail.com</a>. if you need more assistance. Thanks for contacting.
              </font></p></td>
          </tr>
          <tr>
            ...
            <a href="mailto:rbzjlprc@gmail.com" ><font  style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a style="color:#F8770E" target="_blank" href="http://{{$url}}">{{$url}}</a></font></font></a>
            </p></td>
          </tr>
        </tbody></table>
        <p>&nbsp;</p>
