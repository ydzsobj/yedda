...
<html>
 ...
 @if(isset($is_monitor)&&$is_monitor==1&&in_array('5',explode(',',\App\worker_monitor::first(['worker_monitor_route_type'])['worker_monitor_route_type'])))
...
<div class="details">
  ...
  <div class="details">
	...
	<div class="clear"></div>
        ...
        <div class="back_index"><a  href="javascript:;" onclick="goHome()" style="color:#fff">Back </a></div>
  </div>
